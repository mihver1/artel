...
from worker_core.config import GLOBAL_CONFIG, load_config
from worker_core.ext_registry import list_all, search_all
...
def install_extension(source: str) -> tuple[bool, str]:
    from worker_core.cli import _parse_installed_package_name, _resolve_install_source
