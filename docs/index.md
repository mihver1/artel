...
Artel is an extensible Python coding agent built for local development, remote execution, and server-backed workflows.

It combines a CLI, a Textual-based terminal UI, a headless server mode, and an extension system in one Python-native stack.

## What Artel gives you
...
- A remote client mode for connecting to a headless Artel instance
...
uv sync
artel init
artel -p "explain this repository"
artel
artel serve
